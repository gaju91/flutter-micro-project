...
cd /Users/gajanandsharma/ai-learnings/flutter

# Read the detailed curriculum
open micro-apps-curriculum.md

# Create your first app
flutter create 01-counter-history
cd 01-counter-history

# Start coding!
# Follow the curriculum guide for step-by-step instructions
```
...
│
├── 01-counter-history/          (App 1 - your Flutter project)
├── 02-color-picker/             (App 2 - your Flutter project)
├── 03-quick-notes/              (App 3 - your Flutter project)
├── 04-todo-list/                (App 4 - your Flutter project)
├── 05-dog-pictures/             (App 5 - your Flutter project)
├── 06-weather-app/              (App 6 - your Flutter project)
├── 07-expense-tracker/          (App 7 - your Flutter project)
└── 08-pomodoro-timer/           (App 8 - your Flutter project)
```

Each app is a complete Flutter project you'll create and build.
...
1. **Read the guide** for the app (in micro-apps-curriculum.md)
2. **Create Flutter project** for that app
3. **Code step-by-step** following the guide
4. **Test frequently** to see your progress
5. **Understand every line** - ask questions, experiment
...
1. Open `micro-apps-curriculum.md`
2. Read App 1 section completely
3. Create Flutter project for App 1
4. Follow step-by-step instructions
5. Code every line yourself (no copy-paste!)
6. Test & understand
7. Move to App 2

### Option 2: Self-Directed (If you have some experience)

1. Skim the app description in curriculum
2. Try building it yourself first
3. Refer to guide when stuck
...
**Open `micro-apps-curriculum.md` and start with App 1!**
